...
namespace APIVerve.API.CountryCallingCode
{
    ...
    /// <summary>
    /// Client for the CountryCallingCode API
    /// </summary>
...
#endif
    {
        ...
        public CountryCallingCodeAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CountryCallingCodeAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CountryCallingCodeAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        private void ValidateParams(CountryCallingCodeQueryOptions options)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(CountryCallingCodeQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(CountryCallingCodeQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(CountryCallingCodeQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(CountryCallingCodeQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(CountryCallingCodeQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
