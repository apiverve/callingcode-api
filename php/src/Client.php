...
namespace APIVerve\Callingcode;
...
/**
 * Client for the Country Calling Code API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/callingcode?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/callingcode';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\CallingcodeClient] {$message}\n";
        }
    }
}
