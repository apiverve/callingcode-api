# Country Calling Code Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:callingcode-api:1.1.13'
}
```
...
```java
import com.apiverve.callingcode.CountryCallingCodeAPIClient;
import com.apiverve.callingcode.APIResponse;
import com.apiverve.callingcode.APIException;

// Initialize the client
CountryCallingCodeAPIClient client = new CountryCallingCodeAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/callingcode](https://docs.apiverve.com/ref/callingcode)
...
- **Documentation:** [https://docs.apiverve.com/ref/callingcode](https://docs.apiverve.com/ref/callingcode)
- **Issues:** [GitHub Issues](https://github.com/apiverve/callingcode-api/issues)
